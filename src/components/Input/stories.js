...
storiesOf("Components|Input", module)
  ...
  .add("Variations", () => (
    <Container>
      ...
      <Row >
        <Column full>
          <HeaderFont h3 color={"Light-Blue"} label={"No Validation"} />
        </Column>
      </Row>
      <Row>
        <Column full>
      ...
      <Row >
        <Column full>
          <BodyFont color={"Light-Blue"} label={`Regex /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/`} />
        </Column>
        <Column full>
          <BodyFont color={"Light-Blue"} label={`Regex /^\d*$/`} />
        </Column>
      </Row>
      <Row >
        <Column full>
      ...
      <Row >
        <Column full>
          <HeaderFont h3  color={"Yellow"}  label={"Prioritizing Server Validation"} />
        </Column>
      </Row>
      <Row >
        <Column full>
      ...
      <Row >
        <Column full>
          <HeaderFont h3  color={"Light-Blue"}  label={"Loading"} />
        </Column>
      </Row>
      <Row>
        <Column full>
      ...
      <Row >
        <Column full>
          <HeaderFont h3  color={"Green"}  label={"success"} />
        </Column>
      </Row>
      <Row>
        <Column full>
      ...
      <Row >
        <Column full>
          <HeaderFont h3  color={"Light-Blue"}  label={"Disabled"} />
        </Column>
      </Row>
      <Row>
        <Column full>
